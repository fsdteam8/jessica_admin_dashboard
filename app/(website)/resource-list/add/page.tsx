...
interface FormDataState {
  ...
  thumbnail: File | null;
  file: File | null;
  filePreviewUrl: string | null; // Added for file preview
  images: File[];
}
...
export default function ResourceForm() {
  ...
  const fileInputRef = useRef<HTMLInputElement>(null); // Added for file input reference
  ...
  const [formData, setFormData] = useState<FormDataState>({
    ...
    thumbnail: null,
    file: null,
    filePreviewUrl: null, // Added for file preview
    images: [],
  });
    ...
    onSuccess: (data) => {
      ...
      setTimeout(() => {
        ...
        setFormData({
          ...
          thumbnail: null,
          file: null,
          filePreviewUrl: null, // Reset file preview
          images: [],
        });
  ...
  const handleFileUpload = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (formData.filePreviewUrl) {
      URL.revokeObjectURL(formData.filePreviewUrl);
    }
  ...
  useEffect(() => {
    return () => {
      ...
      if (formData.filePreviewUrl) {
        URL.revokeObjectURL(formData.filePreviewUrl); // Cleanup file preview
      }
      imagePreviews.forEach((previewUrl) => URL.revokeObjectURL(previewUrl));
    };
  }, [thumbnailPreview, formData.filePreviewUrl, imagePreviews]);
      ...
      <div className="max-w-9xl mx-auto p-6">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          <div className="space-y-6">
            ...
            <Card>
              <CardHeader>
                <CardTitle>File (PDF, Word, etc.)</CardTitle>
              </CardHeader>
              <CardContent className="pt-6">
                <div className="space-y-2">
                      ...
                      <div className="mt-2 border rounded-lg p-4">
                        ...
                        formData.file?.type === "application/pdf" ? (
                          ...
                          <div className="text-sm text-gray-600">
                            <p>
                              <strong>File Name:</strong> {formData.file.name}
                            </p>
                            <p>
                            ...
                            <p>
                              <strong>File Type:</strong> {formData.file.type}
                            </p>
                            {formData.file.type !== "application/pdf" && (
                              <p className="mt-2 text-gray-500">
                                Preview not available for this file type. Only
                        ...
                        <Button
                          ...
                          className="mt-4 w-full text-red-600 border-red-600 hover:bg-red-50 hover:text-red-700"
                        >
